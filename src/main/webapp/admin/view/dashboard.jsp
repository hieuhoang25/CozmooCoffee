...
<body>
    ...
    <script>
        $(function(){
            let path = ${pageContext.request.contextPath}/admin;
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li class="nav-item "><a class="nav-link active"
						href="${pageContext.request.contextPath}/admin/view/dashboard.jsp">
						...
						<div class="col-md-4">
							<div class="card ">
								...
								<div class="card-body ">
									...
									<div class="legend">
										<i class="fa fa-circle text-info"></i> Đồ ăn <i
											class="fa fa-circle text-danger"></i> Đồ uống
									</div>
									<hr>
									<div class="stats">
										<i class="fa fa-clock-o"></i> % giá trị mỗi loại
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-8">
							<div class="card ">
								<div class="card-header ">
									...
									<p class="card-category">Đã cập nhật</p>
								</div>
								<div class="card-body ">
								...
								<div class="card-footer ">
									<div class="legend">
										<i class="fa fa-circle text-info"></i> Tổng doanh thu
									</div>
									<hr>
									<div class="stats">
